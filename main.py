...
print(f"Count [serial+verses] of even sums: {e_count}")  #count (2+286=288), (4+176=180)...
print(f"Count [serial+verses] of odd sums: {o_count}")  #count (3+200=203), (5+120=125)...
